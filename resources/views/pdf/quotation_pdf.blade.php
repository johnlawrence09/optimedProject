...
<body style="font-family: 'Roboto', sans-serif;">
   <main style="padding: 10px; width: 550; margin: 5px auto;">
      ...
      <p style="letter-spacing: 5px; text-transform:uppercase; text-align:center; margin-bottom:32px; "> Quotation  {{$quote['Ref']}} </p>
      <main>
         <div style="float: left; margin-right: 250px;">
            <p style="font-size: 12px; margin:0; font-weight: 400;"><strong style="margin-right: 30px;">Name:</strong>{{$quote['client_name']}}</p>
            <p style="font-size: 12px; margin:0; font-weight: 400;"><strong style="margin-right: 26px;">Phone:</strong>{{$quote['client_phone']}}</p>
            <p style="font-size: 12px; margin:0; font-weight: 400;"><strong style="margin-right: 16px;">Address:</strong>{{$quote['client_adr']}}<</p>
            <p style="font-size: 12px; margin:0; font-weight: 400;"><strong style="margin-right: 32px;">Email:</strong>{{$quote['client_email']}}</div>
            </td></p>
         </div>
         <div>
            <p style="font-size: 12px; margin:0; font-weight: 400;"><strong style="margin-right: 85px;">Date:</strong>{{$quote['date']}}</p>
            <p style="font-size: 12px; margin:0; font-weight: 400;"><strong style="margin-right: 30px;">Reference no.:</strong>{{$quote['Ref']}}</p>
            <p style="font-size: 12px; margin:0; font-weight: 400;"><strong style="margin-right: 72px;">Status:</strong>{{$quote['statut']}}</p>
      ...
      <table style="margin-top: 32px; font-size: 12px; border-collapse: collapse; width: 100%; ">
         <tr>
           ...
           <th style="border-right:1px solid #343a40; text-align: left; padding: 8px; font-size: 12px; background-color: #4dabf7; color: black; text-transform:uppercase" >UNIT PRICE</th>
       ...
       <main style="width: 550; margin: 0 10px auto auto;" >
        <table style="margin-top: 32px; font-size: 12px; border-collapse: collapse; width: 30%; float:right">
            <tr>
                ...
                <td style="border: 1px solid #343a40; text-align: left; padding: 5px; font-size: 12px;">{{$quote['TaxNet']}} </td>
             </tr>
             <tr>
                <td style="border: 1px solid #343a40; border-top:none; text-align: left; padding: 5px; font-size: 12px;">Discount</td>
                <td style="border: 1px solid #343a40; border-top:none; text-align: left; padding: 5px; font-size: 12px;">{{$quote['discount']}} </td>
             </tr>
             {{-- <tr>
             ...
             <tr>
                ...
                <td style="border: 1px solid #343a40; border-top:none; text-align: left; padding: 5px; font-size: 12px;">{{$symbol}} {{$quote['GrandTotal']}}</td>
             </tr>
